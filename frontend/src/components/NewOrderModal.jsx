  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="w-full max-w-xl bg-white rounded-[32px] border border-slate-100 shadow-2xl overflow-hidden">
          <div className="px-7 py-6 border-b border-slate-50 flex items-center justify-between">
            ...
            <button onClick={close} className="p-2 rounded-2xl hover:bg-slate-50 text-slate-500" aria-label="Close">
              <X className="w-5 h-5" />
            </button>
          </div>
